                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Bayahmedov S.R.',
                            style: GoogleFonts.montserrat(textStyle: kCardUserTextStyle),
                          ),
                          const SizedBox(height: 5,),
                          Text(
                            ' (+ 998 90 211 35 09)',
                            style: GoogleFonts.montserrat(textStyle: kCardNumTextStyle),
                          ),
                        ],
                      ),
                    )
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            _data,
                            style: const TextStyle(fontSize: 18, color: orangeColor),
                          ),
                          const SizedBox(
                            width: 5,
                          ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(cardTransactionList[index].userName, style: GoogleFonts.montserrat(textStyle: kCardTransactionStyle)),
                                          Text(cardTransactionList[index].transactionStatus, style: GoogleFonts.montserrat(textStyle: kCardTransactionStyle))
                                        ],
                                      ),
                                    ),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: <Widget>[
                                          Text(cardTransactionList[index].transactionAmount,style: GoogleFonts.montserrat(textStyle: kCardTransactionStyle),),
                                          Padding(
                                            padding: const EdgeInsets.only(left: 40),
                                            child: Text(cardTransactionList[index].transactionTime,style: GoogleFonts.montserrat(textStyle: kCardTransactionStyle1) ),
                                          )
                                        ],
                                      ),
                                    ),
