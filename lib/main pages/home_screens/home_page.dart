                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 5),
                        Text(' (+ 998 90 211 35 09)', style: kCardNumTextStyle),
                      ],
                    ),
                  ),
                ],
                          ...
                          Row(
                            ...
                            children: [
                                ...
                                children: [
                                  CircleAvatar(
                                    backgroundImage: AssetImage(
                                        cardTransactionList[index].userAvatar),
                                  ),
                                  Padding(
                              ...
                              Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text(cardTransactionList[index].transactionAmount,
                                      style: kCardTransactionStyle),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 50),
                                    child: Text(cardTransactionList[index].transactionTime,
